...
def compile_probe(tmp: Path, source_dir: Path, build_dir: Path) -> Path:
    ...
    cmd = [
        ...
        '-I', str(source_dir / 'runtime' / 'trusted_oracle' / 'include'),
        '-I', str(source_dir / 'runtime' / 'stack_probe' / 'include'),
        '-I', str(source_dir / 'runtime' / 'env_integrity' / 'include'),
        '-I', str(source_dir / 'runtime' / 'state' / 'include'),
        '-I', str(source_dir / 'runtime' / 'integrity' / 'include'),
        '-I', str(source_dir / 'runtime' / 'obfuscation' / 'include'),
        '-I', str(source_dir / 'runtime' / 'self_mod' / 'include'),
        '-I', str(source_dir / 'arch' / 'common' / 'include'),
        '-I', str(source_dir / 'policy' / 'include'),
        '-Wl,--start-group',
        str(build_dir / 'runtime' / 'vm1' / 'libvmp_runtime_vm1.a'),
        str(build_dir / 'runtime' / 'self_mod' / 'libvmp_runtime_self_mod.a'),
        str(build_dir / 'runtime' / 'obfuscation' / 'libvmp_runtime_obfuscation.a'),
        str(build_dir / 'runtime' / 'cryptor' / 'libvmp_runtime_cryptor.a'),
        str(build_dir / 'runtime' / 'strings' / 'libvmp_runtime_strings.a'),
        str(build_dir / 'runtime' / 'audit' / 'libvmp_runtime_audit.a'),
        str(build_dir / 'runtime' / 'trusted_oracle' / 'libvmp_runtime_trusted_oracle.a'),
        str(build_dir / 'runtime' / 'stack_probe' / 'libvmp_runtime_stack_probe.a'),
        str(build_dir / 'runtime' / 'env_integrity' / 'libvmp_runtime_env_integrity.a'),
        ...
        str(build_dir / 'runtime' / 'integrity' / 'libvmp_runtime_integrity.a'),
